  ...
  return (
    <>
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-10 right-6 p-3 rounded-full bg-terminal-bg border border-terminal-border hover:border-terminal-green transition-colors z-50 group"
